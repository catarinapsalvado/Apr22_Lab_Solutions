...
movieRouter.get("/new", (req, res, next) => {
  Celebrity.find()
    ...
    .catch((err) =>
      console.log("Error while displaying a form to create a movie: ", err)
    );
});
...
movieRouter.get("/", (req, res, next) => {
  Movie.find()
    ...
    .catch((err) =>
      console.log("Error while displaying all the movies: ", err)
    );
});
...
movieRouter.get("/:id/edit", (req, res, next) => {
  Movie.findById(req.params.id)
    ...
    .catch((err) =>
      console.log("Error while getting the movie for the edit form: ", err)
    );
});
...
movieRouter.post("/:movieId/update", (req, res, next) => {
  ...
  Movie.findByIdAndUpdate(req.params.movieId, req.body)
    ...
    .catch((err) =>
      console.log("Error while getting updating the movie: ", err)
    );
});
